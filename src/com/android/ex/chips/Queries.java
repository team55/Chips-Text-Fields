...
/* package */class Queries {
    ...
    public static final Query PHONE = buildPhoneQuery();

    private static Query buildPhoneQuery() {
        String[] projection;
        ...
        return new Query(projection, Phone.CONTENT_FILTER_URI, Phone.CONTENT_URI) {
    ...
    public static final Query EMAIL = buildEmailQuery();
    ...
    private static Query buildEmailQuery() {
        ...
        return new Query(projection, Email.CONTENT_FILTER_URI, Email.CONTENT_URI) {
    ...
    static abstract class Query {
        ...
        public static final int PHOTO_ID = 6; // Long
        public static final int DEFAULT_DISPLAY_NAME_SOURCE = 100;
