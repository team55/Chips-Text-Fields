...
public abstract class BaseRecipientAdapter extends BaseAdapter implements Filterable,
     ...
     */
    private static final int ALLOWANCE_FOR_DUPLICATES = 1;
    ...
    private static class TemporaryEntry {
        ...
        public TemporaryEntry(Cursor cursor) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                ...
                long photoId = cursor.getLong(Queries.Query.PHOTO_ID);
                Uri photoUri = ContentUris.withAppendedId(ContactsContract.Data.CONTENT_URI, photoId);
                this.thumbnailUriString = photoUri.toString();
                this.displayNameSource = Queries.Query.DEFAULT_DISPLAY_NAME_SOURCE;
            }
        }
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            try {
                ...
                if (defaultDirectoryCursor == null) {
                    ...
                    if (limit > 0 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                        if (DEBUG) {
     ...
     * construct it, we use {@link #mEntryMap}, {@link #mNonAggregatedEntries}, and {@link #mExistingDestinations}.
     ...
     * contactId (possible if they aren't in local storage) are stored in {@link #mNonAggregatedEntries}.
     ...
     * (for photo). Ids for those should be available via {@link #getDisplayNameId()}, {@link #getDestinationId()}, and
     * {@link #getPhotoId()}.
     */
